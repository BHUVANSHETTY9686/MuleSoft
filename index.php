<?php
    ...
    $sql = "INSERT INTO movie (name , actor , actress , director , year ) VALUES ('ricky' , 'rakshit' , 'charlie' , 'shruthi' , 2003),('' , 'yash' , 'nidhi' , 'neel' , 2022),('ASN' , 'ravi' , 'shreenidhi' , 'prashanth' , 2010),('vikram' , 'kamal' , 'pooja' , 'nelson' , 2022)";       //query
